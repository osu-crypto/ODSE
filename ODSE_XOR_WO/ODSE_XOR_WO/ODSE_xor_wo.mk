...
##
## Debug
ProjectName            :=ODSE_xor_wo
ConfigurationName      :=Debug
WorkspacePath          :=/scratch/simulation_thanghoang/ODSE/PIR_DSSE/ODSE_XOR_WO
ProjectPath            :=/scratch/simulation_thanghoang/ODSE/PIR_DSSE/ODSE_XOR_WO/ODSE_XOR_WO
...
ObjectsFileList        :="ODSE_xor_wo.txt"
PCHCompileFlags        :=
...
$(IntermediateDirectory)/Miscellaneous.cpp$(ObjectSuffix): Miscellaneous.cpp $(IntermediateDirectory)/Miscellaneous.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ODSE/PIR_DSSE/ODSE_XOR_WO/ODSE_XOR_WO/Miscellaneous.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Miscellaneous.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Keyword_Extraction.cpp$(ObjectSuffix): Keyword_Extraction.cpp $(IntermediateDirectory)/Keyword_Extraction.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ODSE/PIR_DSSE/ODSE_XOR_WO/ODSE_XOR_WO/Keyword_Extraction.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Keyword_Extraction.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp $(IntermediateDirectory)/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ODSE/PIR_DSSE/ODSE_XOR_WO/ODSE_XOR_WO/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ODSE.cpp$(ObjectSuffix): ODSE.cpp $(IntermediateDirectory)/ODSE.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ODSE/PIR_DSSE/ODSE_XOR_WO/ODSE_XOR_WO/ODSE.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ODSE.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ODSE_Crypto.cpp$(ObjectSuffix): ODSE_Crypto.cpp $(IntermediateDirectory)/ODSE_Crypto.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ODSE/PIR_DSSE/ODSE_XOR_WO/ODSE_XOR_WO/ODSE_Crypto.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ODSE_Crypto.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ODSE_Hashmap_Key_Class.cpp$(ObjectSuffix): ODSE_Hashmap_Key_Class.cpp $(IntermediateDirectory)/ODSE_Hashmap_Key_Class.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ODSE/PIR_DSSE/ODSE_XOR_WO/ODSE_XOR_WO/ODSE_Hashmap_Key_Class.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ODSE_Hashmap_Key_Class.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ODSE_KeyGen.cpp$(ObjectSuffix): ODSE_KeyGen.cpp $(IntermediateDirectory)/ODSE_KeyGen.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ODSE/PIR_DSSE/ODSE_XOR_WO/ODSE_XOR_WO/ODSE_KeyGen.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ODSE_KeyGen.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ODSE_Trapdoor.cpp$(ObjectSuffix): ODSE_Trapdoor.cpp $(IntermediateDirectory)/ODSE_Trapdoor.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ODSE/PIR_DSSE/ODSE_XOR_WO/ODSE_XOR_WO/ODSE_Trapdoor.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ODSE_Trapdoor.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Client_ODSE.cpp$(ObjectSuffix): Client_ODSE.cpp $(IntermediateDirectory)/Client_ODSE.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ODSE/PIR_DSSE/ODSE_XOR_WO/ODSE_XOR_WO/Client_ODSE.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Client_ODSE.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Server_ODSE.cpp$(ObjectSuffix): Server_ODSE.cpp $(IntermediateDirectory)/Server_ODSE.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ODSE/PIR_DSSE/ODSE_XOR_WO/ODSE_XOR_WO/Server_ODSE.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Server_ODSE.cpp$(ObjectSuffix) $(IncludePath)
