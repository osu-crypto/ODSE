...
public:
    ODSE();
    ~ODSE();
    int loadEncrypted_matrix_from_files(zz_p** I);
    int saveEncrypted_matrix_to_files(zz_p** I);
    ...
    int update(unsigned char* I_prime,               
    ...
    int getBlock( TYPE_INDEX index, zz_p** I, MatrixType* I_prime);
    ...
    zz_p simpleRecover(zz_p* shares);                                        
};
