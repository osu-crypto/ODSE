...
##
## Debug
ProjectName            :=Chor_SEU-DSSE
ConfigurationName      :=Debug
WorkspacePath          :=/scratch/simulation_thanghoang/ODSE/PIR_DSSE/SS/Chor_DSSE_Client/TISSEC
ProjectPath            :=/scratch/simulation_thanghoang/ODSE/PIR_DSSE/SS/Chor_DSSE_Client/TISSEC/SEU-DSSE
...
ObjectsFileList        :="Chor_SEU-DSSE.txt"
PCHCompileFlags        :=
MakeDirCommand         :=mkdir -p
LinkOptions            :=  -lzmq -ltomcrypt -lpthread -lntl -lgmp 
...
$(IntermediateDirectory)/Client_DSSE.cpp$(ObjectSuffix): Client_DSSE.cpp $(IntermediateDirectory)/Client_DSSE.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ODSE/PIR_DSSE/SS/Chor_DSSE_Client/TISSEC/SEU-DSSE/Client_DSSE.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Client_DSSE.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Miscellaneous.cpp$(ObjectSuffix): Miscellaneous.cpp $(IntermediateDirectory)/Miscellaneous.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ODSE/PIR_DSSE/SS/Chor_DSSE_Client/TISSEC/SEU-DSSE/Miscellaneous.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Miscellaneous.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE.cpp$(ObjectSuffix): DSSE.cpp $(IntermediateDirectory)/DSSE.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ODSE/PIR_DSSE/SS/Chor_DSSE_Client/TISSEC/SEU-DSSE/DSSE.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE_Hashmap_Key_Class.cpp$(ObjectSuffix): DSSE_Hashmap_Key_Class.cpp $(IntermediateDirectory)/DSSE_Hashmap_Key_Class.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ODSE/PIR_DSSE/SS/Chor_DSSE_Client/TISSEC/SEU-DSSE/DSSE_Hashmap_Key_Class.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE_Hashmap_Key_Class.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Keyword_Extraction.cpp$(ObjectSuffix): Keyword_Extraction.cpp $(IntermediateDirectory)/Keyword_Extraction.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ODSE/PIR_DSSE/SS/Chor_DSSE_Client/TISSEC/SEU-DSSE/Keyword_Extraction.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Keyword_Extraction.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE_Trapdoor.cpp$(ObjectSuffix): DSSE_Trapdoor.cpp $(IntermediateDirectory)/DSSE_Trapdoor.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ODSE/PIR_DSSE/SS/Chor_DSSE_Client/TISSEC/SEU-DSSE/DSSE_Trapdoor.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE_Trapdoor.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE_KeyGen.cpp$(ObjectSuffix): DSSE_KeyGen.cpp $(IntermediateDirectory)/DSSE_KeyGen.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ODSE/PIR_DSSE/SS/Chor_DSSE_Client/TISSEC/SEU-DSSE/DSSE_KeyGen.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE_KeyGen.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Server_DSSE.cpp$(ObjectSuffix): Server_DSSE.cpp $(IntermediateDirectory)/Server_DSSE.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ODSE/PIR_DSSE/SS/Chor_DSSE_Client/TISSEC/SEU-DSSE/Server_DSSE.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Server_DSSE.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE_Crypto.cpp$(ObjectSuffix): DSSE_Crypto.cpp $(IntermediateDirectory)/DSSE_Crypto.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ODSE/PIR_DSSE/SS/Chor_DSSE_Client/TISSEC/SEU-DSSE/DSSE_Crypto.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE_Crypto.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp $(IntermediateDirectory)/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ODSE/PIR_DSSE/SS/Chor_DSSE_Client/TISSEC/SEU-DSSE/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
