...
##
## Debug
ProjectName            :=ODSE_WO_RO
ConfigurationName      :=Debug
WorkspacePath          :=/scratch/simulation_thanghoang/tmp/ODSE/ODSE_RO_WO
ProjectPath            :=/scratch/simulation_thanghoang/tmp/ODSE/ODSE_RO_WO/ODSE_WO_RO
...
ObjectsFileList        :="ODSE_WO_RO.txt"
PCHCompileFlags        :=
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp $(IntermediateDirectory)/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/tmp/ODSE/ODSE_RO_WO/ODSE_WO_RO/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Client_ODSE.cpp$(ObjectSuffix): Client_ODSE.cpp $(IntermediateDirectory)/Client_ODSE.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/tmp/ODSE/ODSE_RO_WO/ODSE_WO_RO/Client_ODSE.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Client_ODSE.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Keyword_Extraction.cpp$(ObjectSuffix): Keyword_Extraction.cpp $(IntermediateDirectory)/Keyword_Extraction.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/tmp/ODSE/ODSE_RO_WO/ODSE_WO_RO/Keyword_Extraction.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Keyword_Extraction.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Miscellaneous.cpp$(ObjectSuffix): Miscellaneous.cpp $(IntermediateDirectory)/Miscellaneous.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/tmp/ODSE/ODSE_RO_WO/ODSE_WO_RO/Miscellaneous.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Miscellaneous.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ODSE.cpp$(ObjectSuffix): ODSE.cpp $(IntermediateDirectory)/ODSE.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/tmp/ODSE/ODSE_RO_WO/ODSE_WO_RO/ODSE.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ODSE.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ODSE_Crypto.cpp$(ObjectSuffix): ODSE_Crypto.cpp $(IntermediateDirectory)/ODSE_Crypto.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/tmp/ODSE/ODSE_RO_WO/ODSE_WO_RO/ODSE_Crypto.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ODSE_Crypto.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Server_ODSE.cpp$(ObjectSuffix): Server_ODSE.cpp $(IntermediateDirectory)/Server_ODSE.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/tmp/ODSE/ODSE_RO_WO/ODSE_WO_RO/Server_ODSE.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Server_ODSE.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ODSE_Hashmap_Key_Class.cpp$(ObjectSuffix): ODSE_Hashmap_Key_Class.cpp $(IntermediateDirectory)/ODSE_Hashmap_Key_Class.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/tmp/ODSE/ODSE_RO_WO/ODSE_WO_RO/ODSE_Hashmap_Key_Class.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ODSE_Hashmap_Key_Class.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ODSE_KeyGen.cpp$(ObjectSuffix): ODSE_KeyGen.cpp $(IntermediateDirectory)/ODSE_KeyGen.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/tmp/ODSE/ODSE_RO_WO/ODSE_WO_RO/ODSE_KeyGen.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ODSE_KeyGen.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ODSE_Trapdoor.cpp$(ObjectSuffix): ODSE_Trapdoor.cpp $(IntermediateDirectory)/ODSE_Trapdoor.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/tmp/ODSE/ODSE_RO_WO/ODSE_WO_RO/ODSE_Trapdoor.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ODSE_Trapdoor.cpp$(ObjectSuffix) $(IncludePath)
